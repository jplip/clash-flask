...
from model.charactersRarity import *

charactersRarity_api = Blueprint('charactersRarity_api', __name__,
                   url_prefix='/api/charactersRarity')

# API generator https://flask-restful.readthedocs.io/en/latest/api.html#id1
api = Api(charactersRarity_api)
...
if __name__ == "__main__": 
    ...
    url = server + "/api/charactersRarity"
